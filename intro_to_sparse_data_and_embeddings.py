...
train_url = 'https://storage.googleapis.com/mledu_datasets/sparse-data-embedding/train.tfrecord'
train_path = tf.keras.utils.get_file(train_url.split('/')[-1], train_url)
test_url = 'https://storage.googleapis.com/mledu_datasets/sparse-data-embedding/test.tfrecord'
...
my_optimizer = tf.train.AdagradOptimizer(learning_rate=0.1)
my_optimizer = tf.contrib.esetimator.clip_gradients_by_norm(my_optimizer, 5.0)
...
# Task 4 - Convince yourself ther's actually an embedding in there
