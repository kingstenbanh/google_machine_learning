...
# Find an L1 regularization strength parameter which statisfies both constraint 
# modal size is less than 600 and log-loss is less than 0.35 on validation set
